...
This package provides a list of functions to facilitate access to the data offered by [OpenSkyNetwork](https://opensky-network.org/) in its [REST API](https://opensky-network.org/apidoc/rest.html).
